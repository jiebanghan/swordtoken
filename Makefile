...
BDB_CPPFLAGS = -I/usr/local/lib/db4/include
BDB_LIBS = -L/usr/local/lib/db4/lib -ldb_cxx-4.8
...
BOOST_LIBS = -L/usr/lib/x86_64-linux-gnu -lboost_system -lboost_filesystem
...
COV_TOOL_WRAPPER = 
CPP = gcc -E
CPPFLAGS =  -DHAVE_BUILD_INFO -D__STDC_FORMAT_MACROS -DPROVIDE_FUZZ_MAIN_FUNCTION
CXX = g++ -std=c++17
CXXCPP = g++ -std=c++17 -E
CXXDEPMODE = depmode=gcc3
CXXFLAGS =  -fno-extended-identifiers
CYGPATH_W = echo
DEBUG_CPPFLAGS =  -DDEBUG -DDEBUG_LOCKORDER -DABORT_ON_FAILED_ASSUME
DEBUG_CXXFLAGS =  -O0 -g3 -ftrapv
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
DMG = 
...
PACKAGE_STRING = Bitcoin Core 22.99.0
PACKAGE_TARNAME = bitcoin
PACKAGE_URL = https://bitcoincore.org/
PACKAGE_VERSION = 22.99.0
PATH_SEPARATOR = :
PIC_FLAGS = -fPIC
PIE_FLAGS = -fPIE
